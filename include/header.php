...
<body class="index-page">
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <a
      ...
      <h1 class="sitename">Suresh R. Kapadi</h1>
    </a>

    <div class="social-links text-center">
      <a
        href="https://www.linkedin.com/in/suresh-kapadi/"
        target="_blank"
        class="linkedin"><i class="bi bi-linkedin"></i></a>
      <a href="https://github.com/surajkapadi" target="_blank" class="github"><i class="bi bi-github"></i></a>
      <a href="https://x.com/Suresh_Kapadi" target="_blank" class="twitter"><i class="bi bi-twitter-x"></i></a>
      <a
        href="https://www.instagram.com/iamsureshkapadi/"
        target="_blank"
        class="instagram"><i class="bi bi-instagram"></i></a>
      <a
        href="https://www.facebook.com/iamsureshkapadi"
        target="_blank"
